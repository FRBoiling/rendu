...
#include <rendu/net/TcpClient.h>
#include <rendu/net/EventLoop.h>
#include <rendu/net/EventLoopThreadPool.h>
#include <rendu/net/InetAddress.h>
#include <rendu/net/Buffer.h>
#include <rendu/net/TcpConnection.h>
...
class Session : rendu::noncopyable
{
public:
...
class Client : rendu::noncopyable
{
public:
